...
var publish = function(eventType, args, callback){
  ...
  self.queueObject.enqueue(queue, klass, JSON.stringify(payload), function(err, toRun){
...
var publishAt = function(timestamp, eventType, args, callback){
  ...
  self.queueObject.enqueueAt(timestamp, queue, klass, JSON.stringify(payload), function(err){
